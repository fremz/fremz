...
THRESHOLDS = {
    ...
    "Horeca": {
        "marge_brute":        ("higher_better", 40, 25),
        "marge_ebitda":       ("higher_better", 12, 5),
        "marge_nette":        ("higher_better", 5,  1),
        "roe":                ("higher_better", 10, 4),
        "roa":                ("higher_better", 5,  2),
        "liq_generale":       ("higher_better", 1.2, 0.8),
        "liq_reduite":        ("higher_better", 0.7, 0.4),
        "liq_immediate":      ("higher_better", 0.2, 0.05),
        "endettement_global": ("lower_better",  65,  80),
        "gearing":            ("lower_better",  1.5, 3.0),
        "couv_interets":      ("higher_better", 3,   1.5),
        "cap_remboursement":  ("lower_better",  4,   7),
        "dso":                ("lower_better",  15,  30),
        "dpo":                ("range",         30, 60, 15, 75),
        "rotation_stocks":    ("lower_better",  15,  30),
        "bfr_jours":          ("lower_better",  15,  30),
        "autonomie":          ("higher_better", 20,  10),
        "couv_immo":          ("higher_better", 0.8, 0.4),
        "frn":                ("higher_better", 0.01, -0.01),
    },
    "Professions libérales": {
        "marge_brute":        ("higher_better", 60, 35),
        "marge_ebitda":       ("higher_better", 25, 12),
        "marge_nette":        ("higher_better", 15, 6),
        "roe":                ("higher_better", 15, 7),
        "roa":                ("higher_better", 10, 4),
        "liq_generale":       ("higher_better", 1.5, 1.0),
        "liq_reduite":        ("higher_better", 1.3, 0.9),
        "liq_immediate":      ("higher_better", 0.4, 0.2),
        "endettement_global": ("lower_better",  40,  60),
        "gearing":            ("lower_better",  0.3, 1.0),
        "couv_interets":      ("higher_better", 8,   3),
        "cap_remboursement":  ("lower_better",  2,   3.5),
        "dso":                ("lower_better",  30,  60),
        "dpo":                ("range",         20, 45, 10, 60),
        "rotation_stocks":    None,
        "bfr_jours":          ("lower_better",  20,  45),
        "autonomie":          ("higher_better", 45,  25),
        "couv_immo":          ("higher_better", 1.2, 0.7),
        "frn":                ("higher_better", 0.01, -0.01),
    },
    "Construction": {
        "marge_brute":        ("higher_better", 30, 15),
        "marge_ebitda":       ("higher_better", 10, 4),
        "marge_nette":        ("higher_better", 4,  1.5),
        "roe":                ("higher_better", 10, 4),
        "roa":                ("higher_better", 5,  2),
        "liq_generale":       ("higher_better", 1.4, 0.9),
        "liq_reduite":        ("higher_better", 1.1, 0.7),
        "liq_immediate":      ("higher_better", 0.2, 0.05),
        "endettement_global": ("lower_better",  60,  75),
        "gearing":            ("lower_better",  1.0, 2.5),
        "couv_interets":      ("higher_better", 4,   2),
        "cap_remboursement":  ("lower_better",  3,   5),
        "dso":                ("lower_better",  45,  75),
        ...
        "rotation_stocks":    ("lower_better",  30,  60),
        "bfr_jours":          ("lower_better",  45,  75),
        "autonomie":          ("higher_better", 25,  12),
        "couv_immo":          ("higher_better", 0.9, 0.5),
        "frn":                ("higher_better", 0.01, -0.01),
    },
    "Commerce de détail": {
        "marge_brute":        ("higher_better", 35, 20),
        "marge_ebitda":       ("higher_better", 8,  3),
        "marge_nette":        ("higher_better", 3,  1),
        "roe":                ("higher_better", 8,  3),
        "roa":                ("higher_better", 4,  1.5),
        "liq_generale":       ("higher_better", 1.5, 1.0),
        "liq_reduite":        ("higher_better", 0.6, 0.3),
        "liq_immediate":      ("higher_better", 0.15, 0.05),
        "endettement_global": ("lower_better",  60,  75),
        "gearing":            ("lower_better",  1.0, 2.0),
        "couv_interets":      ("higher_better", 3,   1.5),
        "cap_remboursement":  ("lower_better",  3.5, 6),
        "dso":                ("lower_better",  15,  30),
        "dpo":                ("range",         30, 60, 15, 90),
        "rotation_stocks":    ("lower_better",  60,  120),
        "bfr_jours":          ("lower_better",  30,  60),
        "autonomie":          ("higher_better", 25,  12),
        "couv_immo":          ("higher_better", 0.8, 0.4),
        "frn":                ("higher_better", 0.01, -0.01),
    ...
    "Immobilier": {
        "marge_brute":        ("higher_better", 50, 25),
        "marge_ebitda":       ("higher_better", 35, 15),
        "marge_nette":        ("higher_better", 20, 8),
        "roe":                ("higher_better", 6,  2),
        "roa":                ("higher_better", 3,  1),
        "liq_generale":       ("higher_better", 1.2, 0.8),
        "liq_reduite":        ("higher_better", 0.8, 0.4),
        "liq_immediate":      ("higher_better", 0.15, 0.05),
        "endettement_global": ("lower_better",  70,  85),
        "gearing":            ("lower_better",  2.0, 4.0),
        "couv_interets":      ("higher_better", 2,   1.2),
        "cap_remboursement":  ("lower_better",  8,   15),
        "dso":                ("lower_better",  30,  60),
        "dpo":                ("range",         20, 45, 10, 75),
        "rotation_stocks":    None,
        "bfr_jours":          ("lower_better",  15,  45),
        "autonomie":          ("higher_better", 20,  10),
        "couv_immo":          ("higher_better", 0.5, 0.25),
        "frn":                ("higher_better", 0.01, -0.01),
    },
}
